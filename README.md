...
5. Сделать функцию для проведения когорстного анализа пользователей и в период с января по декабрь выявить когорту с самым высоким retention на 3й месяц.
